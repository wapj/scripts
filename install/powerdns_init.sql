...
GRANT ALL ON powerdns.* TO 'pdns'@'localhost' IDENTIFIED BY '패스워드';
FLUSH PRIVILEGES;
USE powerdns;
...
vagrant@pdns:~$ ls
install_mariadb.sh   install.sh            install_virtualbox_guest.sh  sudo
install_powerdns.sh  install_vboxguest.sh  powerdns_init.sql
vagrant@pdns:~$ cat install_powerdns.sh
#!/bin/bash
...
vagrant@pdns:~$ cat powerdns_init.sql
CREATE DATABASE powerdns;
GRANT ALL ON powerdns.* TO 'pdns'@'localhost' IDENTIFIED BY '패스워드';
FLUSH PRIVILEGES;
USE powerdns;
